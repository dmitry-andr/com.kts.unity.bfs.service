...
public class DownloadAchievementsConfigFile extends ActionSupport{
    ...
    public String execute() throws Exception {
        ...
        Resource logFileResource = AppContext.getContext().getResource(ConfigParams.APP_ACHIEVEMENTS_CONFIG_FILE_PATH_NAME);
