...
public class DownloadBotsConfigFile extends ActionSupport{
    ...
    public String execute() throws Exception {
        ...
        Resource logFileResource = AppContext.getContext().getResource(ConfigParams.APP_BOTS_CONFIG_FILE_PATH_NAME);
