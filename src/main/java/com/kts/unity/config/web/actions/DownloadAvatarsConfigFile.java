...
public class DownloadAvatarsConfigFile extends ActionSupport {
    private InputStream fileInputStream;

    @Override
    public String execute() throws Exception {

        Resource logFileResource = AppContext.getContext().getResource(ConfigParams.APP_MOB_AVATARS_CONFIG_FILE_PATH_NAME);
