...
public class DownloadMobileAppConfigFile extends ActionSupport {
    ...
    public String execute() throws Exception {
        ...
        Resource logFileResource = AppContext.getContext().getResource(ConfigParams.APP_MOB_CLIENT_CONFIG_FILE_PATH_NAME);
