...
$(document).delegate("#page2", "pageinit", function(){
    ...
    $( "#page2" ).lazyloader( "reInitialize", options, settings, parameters );
});

$(document).delegate("#pageSingleTop", "pageinit", function(){
	$("#page2").lazyloader();	
	$.mobile.lazyloader.prototype.timeoutOptions.mousewheel = 300;
    $.mobile.lazyloader.prototype.timeoutOptions.scrollstart = 700;
    $.mobile.lazyloader.prototype.timeoutOptions.scrollstop = 100;
    ...
    var settings = {  "pageId"                : "page2",
                      ...
                      "mainId"                : "playersList",
                      "progressDivId"         : "lazyloaderProgressDiv",
                      "moreUrl"               : "get-players-singletop.php",
                      //"clearUrl"              : "/home/clear_session" 
					};
